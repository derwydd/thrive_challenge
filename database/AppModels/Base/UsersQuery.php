...
use \Exception;
use \PDO;
use AppModels\Users as ChildUsers;
 ...
 * @method     ChildUsers|null findOneByUserName(string $user_name) Return the first ChildUsers filtered by the user_name column
 ...
 * @method     ChildUsers[]|Collection findByUserName(string|array<string> $user_name) Return ChildUsers objects filtered by the user_name column
 * @psalm-method Collection&\Traversable<ChildUsers> findByUserName(string|array<string> $user_name) Return ChildUsers objects filtered by the user_name column
...
abstract class UsersQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \AppModels\Base\UsersQuery object.
     *
     * @param string $dbName The database name
     * @param string $modelName The phpName of a model, e.g. 'Book'
     * @param string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\AppModels\\Users', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, first_name, last_name, user_name, password FROM users WHERE id = :p0';
        try {
    ...
    public function filterByUserName($userName = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(UsersTableMap::COL_USER_NAME, $userName, $comparison);
