...
use \Exception;
use \PDO;
use AppModels\UsersQuery as ChildUsersQuery;
use AppModels\Map\UsersTableMap;
...
abstract class Users implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\AppModels\\Map\\UsersTableMap';
    ...
    /**
     * Initializes internal state of AppModels\Base\Users object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\AppModels\\Users'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \AppModels\Users (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \AppModels\Users Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
