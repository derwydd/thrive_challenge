...
abstract class Products implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\AppModels\\Map\\ProductsTableMap';
    ...
    /**
     * Initializes internal state of AppModels\Base\Products object.
     */
    ...
    public function setProductCode($v)
    {
        ...
        if ($this->product_code !== $v) {
            $this->product_code = $v;
            $this->modifiedColumns[ProductsTableMap::COL_PRODUCT_CODE] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProductsTableMap::translateFieldName('ProductCode', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = ProductsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\AppModels\\Products'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(ProductsTableMap::COL_PRODUCT_CODE)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(ProductsTableMap::COL_PRODUCT_CODE)) {
            $criteria->add(ProductsTableMap::COL_PRODUCT_CODE, $this->product_code);
        }
        if ($this->isColumnModified(ProductsTableMap::COL_PRICE)) {
     ...
     * objects.
     *
     * @param object $copyObj An object of \AppModels\Products (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \AppModels\Products Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
