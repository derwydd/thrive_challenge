...
use AppModels\Products;
use AppModels\ProductsQuery;
...
class ProductsTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'AppModels.Map.ProductsTableMap';
     ...
     */
    public const OM_CLASS = '\\AppModels\\Products';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'AppModels.Products';
     ...
     */
    public const COL_PRODUCT_CODE = 'products.product_code';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'ProductName', 'ProductCode', 'Price', ],
        self::TYPE_CAMELNAME     => ['id', 'productName', 'productCode', 'price', ],
        self::TYPE_COLNAME       => [ProductsTableMap::COL_ID, ProductsTableMap::COL_PRODUCT_NAME, ProductsTableMap::COL_PRODUCT_CODE, ProductsTableMap::COL_PRICE, ],
        self::TYPE_FIELDNAME     => ['id', 'product_name', 'product_code', 'price', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'ProductName' => 1, 'ProductCode' => 2, 'Price' => 3, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'productName' => 1, 'productCode' => 2, 'price' => 3, ],
        self::TYPE_COLNAME       => [ProductsTableMap::COL_ID => 0, ProductsTableMap::COL_PRODUCT_NAME => 1, ProductsTableMap::COL_PRODUCT_CODE => 2, ProductsTableMap::COL_PRICE => 3, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'product_name' => 1, 'product_code' => 2, 'price' => 3, ],
        self::TYPE_NUM           => [0, 1, 2, 3, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'Products.ProductCode' => 'PRODUCT_CODE',
        'productCode' => 'PRODUCT_CODE',
        'products.productCode' => 'PRODUCT_CODE',
        'ProductsTableMap::COL_PRODUCT_CODE' => 'PRODUCT_CODE',
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\AppModels\\Products');
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ProductsTableMap::COL_PRODUCT_CODE);
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(ProductsTableMap::COL_PRODUCT_CODE);
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \AppModels\Products) { // it's a model object
