...
class UsersTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'AppModels.Map.UsersTableMap';
     ...
     */
    public const OM_CLASS = '\\AppModels\\Users';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'AppModels.Users';
     ...
     */
    public const COL_USER_NAME = 'users.user_name';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'FirstName', 'LastName', 'UserName', 'Password', ],
        self::TYPE_CAMELNAME     => ['id', 'firstName', 'lastName', 'userName', 'password', ],
        self::TYPE_COLNAME       => [UsersTableMap::COL_ID, UsersTableMap::COL_FIRST_NAME, UsersTableMap::COL_LAST_NAME, UsersTableMap::COL_USER_NAME, UsersTableMap::COL_PASSWORD, ],
        self::TYPE_FIELDNAME     => ['id', 'first_name', 'last_name', 'user_name', 'password', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'FirstName' => 1, 'LastName' => 2, 'UserName' => 3, 'Password' => 4, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'firstName' => 1, 'lastName' => 2, 'userName' => 3, 'password' => 4, ],
        self::TYPE_COLNAME       => [UsersTableMap::COL_ID => 0, UsersTableMap::COL_FIRST_NAME => 1, UsersTableMap::COL_LAST_NAME => 2, UsersTableMap::COL_USER_NAME => 3, UsersTableMap::COL_PASSWORD => 4, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'first_name' => 1, 'last_name' => 2, 'user_name' => 3, 'password' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'userName' => 'USER_NAME',
        'users.userName' => 'USER_NAME',
        'UsersTableMap::COL_USER_NAME' => 'USER_NAME',
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\AppModels\\Users');
        ...
        $this->addColumn('user_name', 'UserName', 'VARCHAR', true, 128, null);
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(UsersTableMap::COL_USER_NAME);
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \AppModels\Users) { // it's a model object
